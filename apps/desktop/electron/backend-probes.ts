...
/**
 * Return the Python snippet used to verify Daat can import far enough to
...
/**
 * Return true iff the Daat runtime import probe exits 0.
 *
 ...
 * its immutable, matching Daat package; it must never fall through to the
