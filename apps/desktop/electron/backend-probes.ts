...
/**
 * Return the Python snippet used to verify BISEO can import far enough to
...
/**
 * Return true iff the BISEO runtime import probe exits 0.
 *
 ...
 * its immutable, matching BISEO package; it must never fall through to the
