...
// NOT ~/.hermes — an upstream Hermes install must never be adopted as our home.
//
...
function fetchPublicJson(url, options: any = {}) {
  ...
  // NO ``X-BISEO-Session-Token`` header — used by the auth-mode probe before
