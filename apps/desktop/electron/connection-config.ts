...
// The Nous portal (NAS) does NOT use Daat gateway session cookies — it is a
...
// Daat Cloud connection (cloud-auto-discovery Q3/Q6): it carries a
 ...
 * the Daat gateway session cookies, so cloud sign-in / discovery liveness
