...
// The Nous portal (NAS) does NOT use BISEO gateway session cookies — it is a
...
// BISEO Cloud connection (cloud-auto-discovery Q3/Q6): it carries a
 ...
 * the BISEO gateway session cookies, so cloud sign-in / discovery liveness
