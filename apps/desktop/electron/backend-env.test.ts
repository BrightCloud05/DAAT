...
test('desktop backend PATH adds Daat-managed bins and missing POSIX sane entries', () => {
...
test('normalizeHermesHomeRoot maps profile homes back to the global Daat root', () => {
  assert.equal(
