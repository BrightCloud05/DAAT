...
test('desktop backend PATH adds BISEO-managed bins and missing POSIX sane entries', () => {
...
test('normalizeHermesHomeRoot maps profile homes back to the global BISEO root', () => {
  assert.equal(
