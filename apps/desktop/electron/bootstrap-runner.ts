 ...
 * bootstrap-runner.ts
 *
 * Drives apps/desktop's first-launch install of Daat Agent by spawning
...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/BrightCloud05/Daat/${ref}/scripts/${scriptName}`
