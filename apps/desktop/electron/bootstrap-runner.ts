 ...
 * bootstrap-runner.ts
 *
 * Drives apps/desktop's first-launch install of BISEO Agent by spawning
...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/biseo-app/biseo-agent/${ref}/scripts/${scriptName}`
