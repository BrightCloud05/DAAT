...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when Daat doesn't know how to remove it. */
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with Daat, 'hub' = installed. */
 ...
 *  not Daat); elsewhere, driver health from `cua-driver doctor`. `null`
