...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when BISEO doesn't know how to remove it. */
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with BISEO, 'hub' = installed. */
 ...
 *  not BISEO); elsewhere, driver health from `cua-driver doctor`. `null`
