...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/BrightCloud05/Daat#bring-your-own-endpoint',
...
export function DesktopOnboardingOverlay({
  ...
  return (
    <div
      className={cn(
        'fixed inset-0 z-(--z-onboarding) flex items-center justify-center bg-(--theme-neutral-chrome) backdrop-blur-xl p-6 transition-opacity duration-[520ms] ease-out',
