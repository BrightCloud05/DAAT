...
/** Why a known Daat command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Daat profile', surface: action('profile') },
  {
    name: '/skin',
  ...
  { name: '/version', description: 'Show Daat Agent version', surface: exec() },
 ...
 * Daat' built-in slash commands — i.e. skill commands (`/gif-search`,
