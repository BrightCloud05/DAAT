...
/** Why a known BISEO command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active BISEO profile', surface: action('profile') },
  {
    name: '/skin',
  ...
  { name: '/version', description: 'Show BISEO Agent version', surface: exec() },
 ...
 * BISEO' built-in slash commands — i.e. skill commands (`/gif-search`,
