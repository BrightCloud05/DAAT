...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/BrightCloud05/Daat/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:BrightCloud05/Daat.git"
REPO_URL_HTTPS="https://github.com/BrightCloud05/Daat.git"
HERMES_HOME="${HERMES_HOME:-$HOME/.daat}"
