...
$RepoUrlSsh = "git@github.com:biseo-app/biseo-agent.git"
$RepoUrlHttps = "https://github.com/biseo-app/biseo-agent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/biseo-app/biseo-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/biseo-app/biseo-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/biseo-app/biseo-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
