...
DEFAULT_AGENT_IDENTITY = (
    ...
    "and you help them build and maintain their personal knowledge vault. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run inside BISEO. When the user needs help with BISEO itself — "
    "configuring, setting up, using, extending, or troubleshooting it — or when "
    "you need to understand your own features, tools, or capabilities, load the "
    "`hermes-agent` skill with skill_view(name='hermes-agent'): it documents the "
    "runtime this app is built on and its proven workflows."
)
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot BISEO itself — its CLI, config, models, providers, tools, "
